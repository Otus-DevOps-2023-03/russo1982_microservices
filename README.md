...
Теперь, когда есть готовый образ с приложением, можно автоматизировать поднятие нескольких инстансов в Yandex Cloud, установку на них докера и запуск там образа **russo1982docker/russo-otus-reddit:1.0**
...
Для запуска инстансов через Terraform следющие файлы были созданы
```bash
$ tree
.
├── infra
